<div class="modal fade" id="add-model" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="add-model-Lavel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ route('course.store') }}" class="js_course_add_modal_form form-group">
                @csrf
                <div class="modal-body text-left">
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-2">
                            ...
                            <div class="valid-feedback text-danger price_error">Narxni kiriting !</div>
                        </div>
                        <div class="col-md-6 mt-2">
                            <div class="form-group">
                                ...
                                <div class="valid-feedback text-danger month_error">Oyni tanlang!</div>
                            </div>
                        </div>
                    </div>
                </div>
